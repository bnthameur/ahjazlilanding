...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[72vh] flex items-center justify-center overflow-hidden pt-16 sm:pt-14">
      {/* Background Elements */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <Emoji name="party-popper" width={20} />
            <span>{t('badge')}</span>
          </motion.div>
          ...
          >
            <a href={`/${locale}/salles`} className="w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-lg transition-all duration-200 flex items-center justify-center gap-2">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
              {t('cta_browse')}
            </a>
            <a href={`https://app.ahjazliqaati.com/${locale}/register`} className="w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 bg-white hover:bg-slate-50 text-slate-700 font-semibold rounded-lg border border-slate-200 transition-all duration-200 flex items-center justify-center gap-2">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            <div className="text-center">
              ...
              <div className="text-sm text-slate-600">{t('stats_wilayas')}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-primary-600 mb-1">500+</div>
              <div className="text-sm text-slate-600">{t('stats_venues')}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-primary-600 mb-1">8</div>
              <div className="text-sm text-slate-600">{t('stats_categories')}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-primary-600 mb-1">{t('stats_free_label')}</div>
              <div className="text-sm text-slate-600">{t('stats_free')}</div>
            </div>
          </motion.div>
        </div>
      </div>
