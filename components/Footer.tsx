...
export default function Footer() {
    ...
    const footerLinks = {
        platform: [
            ...
            { name: t('links.list_venue'), href: `https://app.ahjazliqaati.com/${locale}/register` },
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
                    ...
                    <div className="col-span-2 lg:col-span-1">
                        <Link href="/" className="inline-flex items-center mb-4">
                            <Image src="/logo.png" alt="Ahjazli Qaati" width={200} height={46} className="h-11 w-auto object-contain brightness-0 invert" unoptimized />
                        </Link>
